        ...
        <div className="flex items-center justify-between">
          ...
          <AnimatePresence>
            {activeDropdown === "Products" && (
              ...
              >
                <div className="bg-white rounded-xl shadow-[0_40px_100px_rgba(0,0,0,0.5)] overflow-hidden border border-white/20">
                  <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-4 bg-gray-100/80 p-9 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="aspect-[4/3] w-full rounded-xl overflow-hidden shadow-lg border border-gray-200">
                          <img
                      ...
                      <Button
                        ...
                        className="group relative inline-flex items-center justify-between px-5 py-3 rounded-xl font-black text-sm transition-all shadow-[0_4px_12px_rgba(218,41,28,0.3)] mt-8 w-fit gap-6"
                      >
